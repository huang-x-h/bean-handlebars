...
registerHelper('panel', function(options) {
...
registerHelper('panel-header', function(options) {
...
registerHelper('panel-collapse-header', function(options) {
  var ret = '<div class="panel-heading"><span class="panel-title">';
  ret += options.fn(this);
...
registerHelper('panel-body', function(options) {
...
registerHelper('panel-collapse-body', function(options) {
...
registerHelper('panel-footer', function(options) {
